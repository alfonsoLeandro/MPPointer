...
public class RemoveHandler extends AbstractHandler{
    ...
    public RemoveHandler(Pointer plugin, AbstractHandler successor) {
    ...
    protected void internalHandle(CommandSender sender, String label, String[] args) {
        ...
        persistentDataContainer.remove(this.settings.getPointerNamespacedKey());
        itemInHand.setItemMeta(itemMeta);

        this.messageSender.send(sender, Message.POINTER_REMOVED);
